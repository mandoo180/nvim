...
_G.packer_plugins = {
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["project.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/project.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/vim-bbye",
